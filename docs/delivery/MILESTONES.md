...
| M4 — Location, settings and persistence foundation | Done | Pure location policy, one-shot foreground provider, manual/default flows, no-backup DataStore, lifecycle/time seams and fakes | 5 | Medium; High privacy/lifecycle review | DA-004 + DP-001 Approved; V1-M4-01–05 Done; owner-authorized UI-004 town-only exception for the frozen nine-town catalogue | Final independent QA passed with zero open Critical/High/Medium findings; representative API-36 connected evidence passed; Lead/owner accepted; fast-forward into `dev` authorized |
...
DA-004 and DP-001 are Approved. M1–M4 are Done and accepted and did not depend on CP-003. M5 remains unstarted and depends on PA-004-approved SOLAR-001 and the accepted M1 quality baseline. M6 depends on completed/accepted M5 and approved CP-001. M8 remains Blocked by PA-003/CP-003. M9 must not silently omit the approved Option C Rahu allocation: M8 must be accepted or the repository owner must explicitly defer daytime Rahu from the release.
