...
| M4 — Location, settings and persistence foundation | In Progress | Corrective QA pass for pure location policy, one-shot foreground provider, manual/default flows, no-backup DataStore, lifecycle/time seams and fakes | 5 | Medium; High privacy/lifecycle review | DA-004 + DP-001 Approved; implementation-complete V1-M4-01–05; owner-authorized UI-004 town-only exception for the frozen nine-town catalogue | Repeat independent QA and Lead acceptance; M4 is not accepted or merged |
