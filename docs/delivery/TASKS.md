...
| Approval state | DP-001 Approved on 2026-08-02; V1-M1-01 and V1-M1-02 Done; all other tasks retain their listed dependencies and remain Proposed or Blocked until explicitly started |
...
DA-004 and DP-001 are Approved. V1-M1-01 and V1-M1-02 are Done on `milestone/M1-android-foundation`; the permanent identity is `Jyotisha` / `io.github.dinujaya77.jyotisha`. Other tasks remain Proposed or Blocked until explicitly started. V1-M1-03 is the next dependency-eligible task. M5 still needs the accepted M1 quality baseline; M6 waits for accepted M5 and approved CP-001; M7 waits for M3–M6; M8 remains Blocked by PA-003/CP-003; M9 remains evidence/release gated.
