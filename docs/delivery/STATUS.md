...
- Town catalogue: the exact nine owner-approved GeoNames `LK.zip` product rows, Colombo default, hash and review are recorded in [V1-M4-04 Town Catalogue Evidence](V1-M4-04_TOWN_CATALOG_EVIDENCE.md); V1-M4-04 is Done. No M4-05/UI/repository/provider/network assembly is authorized.
