...
| V1-M4-04 | Implementation-complete, **In Progress — corrective QA**; FR-006/009, ADR-004; exact owner-approved GeoNames LK product subset, stable IDs, Colombo default, English-only resources and provenance in [evidence](V1-M4-04_TOWN_CATALOG_EVIDENCE.md); `TownCatalogTest` passes. UI-004 province/region display awaits approved labels/source/schema or a UI exception; no catalogue data is invented. |
