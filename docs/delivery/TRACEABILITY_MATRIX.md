...
| Approval state | Requirements/rules/architecture/SOLAR/UI/delivery trace Approved as recorded; DA-004 and DP-001 Approved 2026-08-02; M1 and M2 Done, accepted and incorporated into `dev`; V1-M3-01 through V1-M3-04 Done on the M3 milestone branch; M3 In Review, not accepted, incorporated, or pushed; remaining mappings do not start implementation |
